...
assert fx39['speed'] == 50 and fx39['f9'] == 70
fx39['f9'] = 25
by_id[39]['name'] = 'ACC06 Lent'
fx35 = by_id[35]['color_fx1'][0]
assert fx35['f5'] == {'hex': 'f00100'}
fx35['f5'] = {'hex': '0001'}   # varints [0, 1]
by_id[35]['name'] = 'ACC06 PadX'
w.replace(165, C.encode(165, d))
w.replace(101, C.encode(101, {'name': 'WMX TEST ACC-06'}))
...
for p in ps:
    if p.get('id') in (35, 39):
        fx = p['color_fx1'][0]
        print(p['id'], repr(p['name']), '| f5', fx.get('f5'), '| vitesse', fx.get('speed'), '| f9', fx.get('f9'))
