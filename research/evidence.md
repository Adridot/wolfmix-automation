...
| COV-28 | 2026-09-01 (planned) | What `160.f7` says about the fixture COV-27 proved it encodes. A third macro, same profile, same feature, same value, **only the fixture differs** — the second moving head instead of the first. Sheet: [`corpus/experiments/COV-28/prediction.md`](../corpus/experiments/COV-28/prediction.md). | planned | §3 |
