...
| SPLIT-01 | 2026-08-31 | Six measures re-running read, named mode, preset recall and one experiment deploy after phase 2 split the device path into four modules → **prediction published, not yet measured**. Three of the six compare against a point written before the split. | published, not measured | — |
