...
| The two FX pages per engine ("Double Trouble") | 🟡 one `f16` slice per engine covers **both** pages; the per-group page selector is `165.f7`, `0` = `FX1` / `1` = `FX2` — **validated** against the panel screen, never written by us |
